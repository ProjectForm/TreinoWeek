...
// useWorkoutData.js). Mesma escala de tamanhos que WeightInput.
  ...
  return (
    <div className="flex items-center gap-1.5 min-w-0">
      ...
      <input
        ...
        className={
          "min-w-[44px] w-11 h-8 bg-transparent text-center font-bold text-ink-primary outline-none rounded-[var(--radius-xs)] " +
